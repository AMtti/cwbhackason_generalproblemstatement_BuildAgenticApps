...
def create_embedding_and_save_to_cosmos_db(text, law_title, article_title, article_caption):


    # Cosmos DBの接続情報
    connection_string = seclet_client.get_secret("connectionstringCosmosDB").value
    ...
    item = {
        "id": str(uuid.uuid4()),
        "種別": law_title,
        "条文名": f"{article_title}{article_caption}",
        "内容": text,
        "embedding": embedding       
    }
